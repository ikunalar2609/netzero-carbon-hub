...
const articles: SubstackArticle[] = [
  {
    title: "What Kunal Think: Market for Correcting Mistakes",
    description: "Human complexity can dry lakes and make deserts bloom. Before drawing environmental conclusions, let's examine the full story.",
    date: "May 1, 2023",
    url: "https://idlerwritingeveryday.substack.com/p/what-kunal-think-market-for-correcting",
    image: "/lovable-uploads/a7ee8375-2b69-4e51-840d-a877269d0037.png",
  },
  {
    title: "JSW Steel's Climate Action Report: Balancing Economic Growth and Climate Responsibility",
    description: "An in-depth dive into how JSW Steel aims to align industrial expansion with sustainability goals.",
    date: "May 5, 2023",
    url: "https://idlerwritingeveryday.substack.com/p/jsw-steels-climate-action-report",
    image: "/lovable-uploads/f5feef21-d5ea-4dfc-80ed-f9713d106f7c.png",
  },
  {
    title: "Global Carbon Council launches GCCTA001 & GCCTA008",
    description: "These tools aim to improve standardization of GHG emissions and carbon stock estimation in NbS projects.",
    date: "May 10, 2023",
    url: "https://idlerwritingeveryday.substack.com/p/global-carbon-council-gcc-launched",
    image: "/lovable-uploads/f4f84a9a-0e26-4a8a-a438-50b4f12c14f0.png",
  },
      ...
      >
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-12">
          <div>
            <h2 className="text-3xl md:text-4xl font-bold mb-3">From My Blog: Idler Writing Everyday</h2>
            <p className="text-muted-foreground max-w-2xl">
              Dive into thoughtful commentary on carbon markets, climate finance, global sustainability reports, and environmental legislation. Whether you're a policymaker, practitioner, or enthusiast—these insights help decode the climate conversation.
            </p>
          </div>
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="mt-4 md:mt-0 inline-flex items-center text-primary hover:underline whitespace-nowrap"
          >
            <BookOpen className="h-5 w-5 mr-2" />
            Visit Blog
          </a>
