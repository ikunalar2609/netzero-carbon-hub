...
const formSchema = z.object({
  ...
  mobile: z.string().min(6, { message: "Valid mobile number required" }).max(20),
      ...
      <div className="w-full max-w-md px-4">
        <Card className="w-full">
          <CardHeader className="space-y-1 text-center">
            ...
            <CardDescription>
              Enter your details below to create your FarmlyCarbon account
            </CardDescription>
          </CardHeader>
          <CardContent>
            <Form {...form}>
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-3">
                      ...
                      <FormItem>
                        ...
                        <FormControl>
                          <div className="relative">
                            ...
                            <Input placeholder="+91..." className="pl-10" {...field} />
                          </div>
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                ...
                <button
                  ...
                  className="w-full h-10 rounded-lg border border-border bg-background hover:bg-muted text-foreground text-[12px] font-semibold transition-all flex items-center justify-center gap-2.5"
                >
